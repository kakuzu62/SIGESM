...
def test_valid_official_swap() -> None:
    ...
    swap = OfficialSwap.request(
        first.id, ExchangeReason("Troca operacional planejada"), first_assignment, second_assignment
    )
...
def test_official_swap_denied_by_rest() -> None:
    ...
    swap = OfficialSwap.request(
        first.id,
        ExchangeReason("Troca por necessidade do servico"),
        first_assignment,
        second_assignment,
    )
...
def test_official_swap_with_formal_exception() -> None:
    ...
    swap = OfficialSwap.request(
        first.id, ExchangeReason("Excecao formal autorizada"), first_assignment, second_assignment
    )
...
def test_valid_service_sale() -> None:
    ...
    sale = ServiceSale.request(
        seller.id,
        ExchangeReason("Venda autorizada pelo comando"),
        seller_assignment,
        buyer_assignment,
    )
...
def test_service_sale_denied_by_buyer_ineligibility() -> None:
    ...
    sale = ServiceSale.request(
        seller.id,
        ExchangeReason("Venda solicitada ao comando"),
        seller_assignment,
        buyer_assignment,
    )
...
def test_service_sale_preserves_buyer_counter_and_resets_seller_counter() -> None:
    ...
    sale = ServiceSale.request(
        seller.id,
        ExchangeReason("Venda com registro extraordinario"),
        seller_assignment,
        buyer_assignment,
    )

...
from domain.service_scale.exceptions import InvalidServiceRoleException
from shared.kernel.value_object import ValueObject


class ServiceRoleName(ValueObject):
    """Name of a role performed during a service scale."""
    ...
    def __init__(self, value: str) -> None:
        ...
        if len(normalized) < 3 or len(normalized) > 80:
            raise InvalidServiceRoleException("Service role name must have 3 to 80 characters.")

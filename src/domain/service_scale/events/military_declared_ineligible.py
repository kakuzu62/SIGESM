...
class MilitaryDeclaredIneligible(DomainEvent):
    """Event raised when a military person is declared ineligible for a service."""

    __slots__ = ("military_id", "reasons", "scale_id", "scale_type", "service_date")

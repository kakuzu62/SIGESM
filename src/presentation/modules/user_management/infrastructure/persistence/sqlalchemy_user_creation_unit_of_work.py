...
class SqlAlchemyUserCreationUnitOfWork(UserCreationUnitOfWork):
    """SQLAlchemy Unit of Work for user creation."""
    ...
    def __enter__(self) -> SqlAlchemyUserCreationUnitOfWork:
    ...
    def commit(self) -> None:
        ...
        try:
            ...
            raise UserCreationConflictError("Unique user constraint violated.") from exc
...
class SqlAlchemyUserCreationUnitOfWorkFactory(UserCreationUnitOfWorkFactory):
    """Factory for SQLAlchemy user creation Unit of Work instances."""

    def __init__(self, session_factory: DatabaseSessionFactory) -> None:
        self._session_factory = session_factory

    def create(self) -> SqlAlchemyUserCreationUnitOfWork:
        """Create a Unit of Work using a fresh session context."""
        return SqlAlchemyUserCreationUnitOfWork(SessionContext(self._session_factory))

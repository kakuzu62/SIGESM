...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._view_factories: dict[str, Callable[[], QWidget]] = {
            ...
            "users": self._user_management_view,
    ...
    def _register_modules(self) -> None:
        for order, (key, title, factory) in enumerate(
            (
                ...
                ("users", "Usuarios", self._user_management_view),
    ...
    def _user_management_view(self) -> QWidget:
        return UserListView(UserViewModel(self._context.user_management))
